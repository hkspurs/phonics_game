...
- Name: e2e_stress.spec.js >> Extreme Stress Tests - Trust No State >> TC021: Cross-Subject State Leakage Test
- Location: tests/e2e_stress.spec.js:43:3
...
=========================== logs ===========================
waiting for navigation to "**/math/map" until "load"
  navigated to "http://localhost:5173/math/gym"
============================================================
```
